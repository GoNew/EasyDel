...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#senderevalpointinfo1").html("0");
		$("#senderevalpointinfo2").html("0");
		$("#senderevalpointinfo3").html("0");
...
<div id="formcss" class="uk-align-center"> 
	...
	<form action="<%=request.getContextPath()%>/mylist" >
		<div style="width:100%;height:140px;font-size: 25px">
			<div id ="couriereval">
				...
				<div>
					<div style="height:10px"></div>
					<div style="font-size: 23px; width: 100px;"><span id="senderevalpointinfo1"></span>점</div>
				</div>
			</div>
			<div style="height:10px"></div>
			<div id ="couriereval">
				...
				<div>
					<div style="height:10px"></div>
					<div id="courierdiv">accuracy</div>
				</div>
				<div>
					<div style="height:10px"></div>
					<div style="width: 20px"> : </div>
				...
				<div>
					<div style="height:10px"></div>
					<div style="font-size: 23px; width: 100px;"><span id="senderevalpointinfo2"></span>점</div>
				</div>
			</div>
			<div style="height:10px"></div>
			<div id ="couriereval">
				...
				<div>
					<div style="height:10px"></div>
					<div style="font-size: 23px; width: 100px;"><span id="senderevalpointinfo3"></span>점</div>
				</div>
			</div>
			<div style="height:10px"></div>
		</div>
		...
		<div id="courierevaltwo">
			...
			<div style="width:720px">
				<header class="uk-comment-header">
					<input type="text" size="90" pattern="{0,100}" title="100자 이하로 작성해주세요." placeholder="여기에 코멘트를 달아주세요" style="font-size:13px;height: 50px;" >
	            </header>
	        </div>
		</div>
		<div style="height:40px"></div>
