...
<hr color="#808080">
	...
	<div id="subproductinfo">
		...
		<div id="row3"><div id="col1">물품 상세</div><div><textarea class="productdetails" name="cargoDesc" required placeholder="*상세 정보는 거래 시 중요한 정보이므로, 최대한 자세하게 작성하기실 부탁드립니다."></textarea></div></div>
	</div>
...
<hr color="#808080">
	<div class="uk-width-1-1" id="row1"> <div class="uk-width-1-2" id="row1"><div id="col1">이름</div><div id=""><input id="receiverName" class="nametext greycolor" type="text" name="receiverName" value="<%=loginUser.getUserName() %>" readonly></div></div><div class="uk-width-1-2" id="row1"><div id="col1">전화번호</div><div id=""><input id="receiverPhone" class="phonetext greycolor" type="text" name="receiverPhone" value="<%=loginUser.getUserPhone() %>" required></div></div></div>
