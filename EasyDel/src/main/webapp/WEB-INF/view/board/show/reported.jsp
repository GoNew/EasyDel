...
<body>
	<div id=fullbrowser align="center">
		<div id="middlebrowser" align="center" style="border: 1px solid red;">
<!-- --------------------------------신고 내용---------------------------------------------- -->		
		<div class="row_request"><div class="text_middle_subject">신고 내용</div></div>
		<div class="replace_hr"></div>
		<div class="standard_row_request"> <div class="row_standard_text_middle">신고 사유</div> 				<div class="text_middle">불량 물품</div> </div>
		<div class="standard_row_request"> <div class="row_standard_text_middle">신고 내용</div> 				<div id="report_detail">불량 물품을 올려놓고, 멀쩡한 척을 합니까? ㅡㅡ 나쁜놈 입니다...</div> </div>
		
		<div class="margin_top_10px"></div>
<!-- --------------------------------발송인 정보---------------------------------------------- -->		
		<div class="row_request margin_top_80px"><div class="text_middle_subject">발송인 정보</div></div>
		<div class="replace_hr"></div>
...
<!-- --------------------------------보내는 사람---------------------------------------------- -->		
		<div class="row_request margin_top_40px"><div class="text_middle_subject">보내는 사람</div></div>
...
<!-- --------------------------------받는 사람---------------------------------------------- -->		
		<div class="row_request margin_top_40px"><div class="text_middle_subject">받는 사람</div></div>
		<div class="replace_hr_plus"></div>
