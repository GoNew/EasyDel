...
<!-- --------------------------------신고 내용---------------------------------------------- -->		
		...
		<div class="margin_top_10px uk-panel uk-panel-box">
			<div class="standard_row_request"> <div style="text-align: center;" class="row_standard_text_middle fixed_font_color">신고 사유</div> 				<div class="text_middle unfixed_font_color">불량 물품</div> </div>
			<div class="standard_row_request"> <div style="text-align: center;" class="row_standard_text_middle fixed_font_color">신고 내용</div> 				<div id="report_detail" class="unfixed_font_color">불량 물품을 올려놓고, 멀쩡한 척을 합니까? ㅡㅡ 나쁜놈 입니다...</div> </div>
		</div>
<!-- --------------------------------발송인 정보---------------------------------------------- -->		
