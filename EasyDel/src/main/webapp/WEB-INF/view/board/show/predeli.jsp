...
<!-- --------------------------------물품 정보---------------------------------------------- -->		
	...
	<div class="row_request margin_top_80px"><div class="text_middle_subject fixed_font_color">물품 정보</div></div>
		...
		<div class="webkit_box margin_top_10px uk-panel uk-panel-box" align="left">
			<a href="<%=request.getContextPath()%>/img/temp/hpcase.jpg" class="uk-overlay" data-uk-lightbox title="물품 원본 사진" id="wrapper_product_img_div">
...
<!-- --------------------------------추가 대화---------------------------------------------- -->		
		<div class="row_request margin_top_80px"><div class="text_middle_subject fixed_font_color">추가 사항</div></div>
			...
			<div class="standard_row_request_reply">
				...
				<a href="<%=request.getContextPath()%>/img/temp/anothercase.jpg" data-uk-lightbox title="물품 원본 사진" class="margin_left_50px uk-overlay"><img class="img_fixed_size_extra" src="<%=request.getContextPath()%>/img/temp/anothercase.jpg"><div class="uk-overlay-area"></div></a>
