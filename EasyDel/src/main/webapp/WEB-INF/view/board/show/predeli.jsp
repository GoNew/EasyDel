...
<!-- ------------------------------버튼------------------------------- -->
		...
		<div id="wrapper_recept_deli_btn_div" align="center"><button class="removeBorder uk-button uk-width-1-2 recept_deli_btn" onclick="$('#applyTransferRequest').submit()">운송 신청</button></div>
		<%	} %>
		</div>
	</div>
